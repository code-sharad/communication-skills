# My Personal Word Bank & Usage Wisdom

A living collection of words, transformed from simple lists into **contextual weapons**.

---

## 🚫 The "Lazy Word" Ban List
*Stop using these. They hide your intelligence.*

- **Good/Bad**: (Too vague)
- **Very**: (Lazy amplifier)
- **Basically/Actually**: (Filler trash)
- **Thing/Stuff**: (Lazy naming)
